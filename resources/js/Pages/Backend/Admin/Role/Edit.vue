...
// Initialize form with current role's permissions
const form = ref({
    name: role?.name,
...
const submitForm = () => {
    router.put(`/admin/role/${role?.id}`, form.value, {
        onSuccess: data => {
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-md-3" v-for="(module, key) in modules" :key="key">
                                            <div class="card border h-100">
                                                ...
                                                <div class="card-body">
                                                    <div v-for="(item, key) in module" class="form-check form-switch form-switch-md mb-3" dir="ltr" :key="key">
                                                        <input
