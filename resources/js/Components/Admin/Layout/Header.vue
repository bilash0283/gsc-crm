            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box">
                    <a href="/admin/dashboard" class="logo">
                        <h1 class="mt-3"><span class="fw-bolder"><span class="text-primary">G</span><span>S</span><span
                                    class="text-danger">C</span></span> Crm</h1>
            ...
            <div class="d-flex">
                ...
                <div class="dropdown d-inline-block">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a @click="logout()" class="dropdown-item text-danger" href="#"><i
